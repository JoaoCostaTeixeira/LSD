...
SIGNAL \inst3|s_count~4_combout\ : std_logic;
SIGNAL \inst3|s_count[3]~1_combout\ : std_logic;
SIGNAL \inst3|s_count~3_combout\ : std_logic;
SIGNAL \inst3|Add0~0_combout\ : std_logic;
SIGNAL \inst3|s_count~2_combout\ : std_logic;
SIGNAL \inst3|s_count~0_combout\ : std_logic;
...
-- Equation(s):
-- \inst2|LessThan0~5_combout\ = (((!\inst2|s_divCounter\(14)) # (!\inst2|s_divCounter\(15))) # (!\inst2|s_divCounter\(13))) # (!\inst2|s_divCounter\(12))
...
-- Equation(s):
-- \inst2|LessThan0~2_combout\ = ((!\inst2|s_divCounter\(17) & !\inst2|s_divCounter\(18))) # (!\inst2|s_divCounter\(23))
...
-- Equation(s):
-- \inst2|LessThan0~3_combout\ = ((!\inst2|s_divCounter\(24) & ((\inst2|LessThan0~2_combout\) # (!\inst2|clkOut~3_combout\)))) # (!\inst2|s_divCounter\(25))
...
-- Equation(s):
-- \inst2|clkOut~0_combout\ = (!\inst2|s_divCounter\(8) & (!\inst2|s_divCounter\(7) & (!\inst2|s_divCounter\(10) & !\inst2|s_divCounter\(9))))
...
-- Equation(s):
-- \inst2|clkOut~4_combout\ = (\inst2|s_divCounter\(12) & (\inst2|s_divCounter\(13) & (!\inst2|s_divCounter\(6) & \inst2|s_divCounter\(14))))
...
-- Equation(s):
-- \inst2|clkOut~5_combout\ = (\inst2|s_divCounter\(11) & (!\inst2|s_divCounter\(17) & (!\inst2|s_divCounter\(15) & \inst2|s_divCounter\(16))))
...
-- Equation(s):
-- \inst2|clkOut~7_combout\ = (\inst2|clkOut~4_combout\ & (\inst2|clkOut~5_combout\ & \inst2|clkOut~6_combout\))
...
-- Equation(s):
-- \inst2|clkOut~8_combout\ = (\inst2|clkOut~0_combout\ & (\inst2|clkOut~2_combout\ & (\inst2|clkOut~3_combout\ & \inst2|clkOut~7_combout\)))
...
-- Equation(s):
-- \inst2|clkOut~9_combout\ = (!\inst2|LessThan0~6_combout\ & ((\inst2|clkOut~8_combout\) # (\inst2|clkOut~q\)))
...
\inst3|s_count~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_count~4_combout\ = (!\SW[0]~input_o\ & !\inst3|s_count\(0))
...
PORT MAP (
	...
	combout => \inst3|s_count~4_combout\);
...
PORT MAP (
	...
	d => \inst3|s_count~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst3|s_count\(0));

-- Location: LCCOMB_X96_Y72_N18
\inst3|s_count[3]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_count[3]~1_combout\ = (((!\inst3|s_count\(3)) # (!\inst3|s_count\(2))) # (!\inst3|s_count\(1))) # (!\inst3|s_count\(0))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|s_count\(0),
	datab => \inst3|s_count\(1),
	datac => \inst3|s_count\(2),
	datad => \inst3|s_count\(3),
	combout => \inst3|s_count[3]~1_combout\);

-- Location: LCCOMB_X96_Y72_N28
\inst3|s_count~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_count~3_combout\ = (!\SW[0]~input_o\ & (\inst3|s_count[3]~1_combout\ & (\inst3|s_count\(0) $ (\inst3|s_count\(1)))))
...
PORT MAP (
	...
	datad => \inst3|s_count[3]~1_combout\,
	combout => \inst3|s_count~3_combout\);
...
-- Equation(s):
-- \inst3|Add0~0_combout\ = (\inst3|s_count\(0) & \inst3|s_count\(1))
...
PORT MAP (
	datac => \inst3|s_count\(0),
	datad => \inst3|s_count\(1),
	combout => \inst3|Add0~0_combout\);

-- Location: LCCOMB_X96_Y72_N30
\inst3|s_count~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_count~2_combout\ = (!\SW[0]~input_o\ & (\inst3|s_count[3]~1_combout\ & (\inst3|Add0~0_combout\ $ (\inst3|s_count\(2)))))
...
PORT MAP (
	...
	datac => \inst3|s_count\(2),
	datad => \inst3|s_count[3]~1_combout\,
	combout => \inst3|s_count~2_combout\);

-- Location: FF_X96_Y72_N31
...
PORT MAP (
	clk => \inst2|clkOut~clkctrl_outclk\,
	d => \inst3|s_count~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst3|s_count\(2));

-- Location: LCCOMB_X96_Y72_N24
\inst3|s_count~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_count~0_combout\ = (!\SW[0]~input_o\ & (\inst3|s_count\(3) $ (((\inst3|s_count\(2) & \inst3|Add0~0_combout\)))))
...
PORT MAP (
	...
	combout => \inst3|s_count~0_combout\);
